...
Private Sub ExtractYearMonth(ByVal fileName As String, ByRef yr As String, ByRef mn As String)
    ...
    For Each p In parts
        ...
        Select Case p
            Case "jan", "january": mn = "January"
            Case "feb", "february": mn = "February"
            Case "mar", "march": mn = "March"
            Case "apr", "april": mn = "April"
            Case "may": mn = "May"
            Case "jun", "june": mn = "June"
            Case "jul", "july": mn = "July"
            Case "aug", "august": mn = "August"
            Case "sep", "sept", "september": mn = "September"
            Case "oct", "october": mn = "October"
            Case "nov", "november": mn = "November"
            Case "dec", "december": mn = "December"
        End Select
