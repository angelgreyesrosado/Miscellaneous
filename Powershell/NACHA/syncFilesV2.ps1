...
param (
    [string]$SRC_DIR=$( Read-Host "Enter source directory" ), 
    [string]$DST_DIR=$( Read-Host "Enter destination directory" ),
...
Write-Debug "Source Dir: $SRC_DIR"
Write-Debug "Destination Dir: $DST_DIR"
